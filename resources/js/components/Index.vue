    ...
    <Header :token="content"></Header>
        ...
        <div class="slider-area ">
            ...
            <div class="slider-active">
                <div class="single-slider slider-height" data-background="http://127.0.0.1:8000/assets/img/hero/h1_hero.jpg">
                    <div class="container">
            ...
            <div class="container">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            <div v-for="products in Products" :key="products.id" class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    ...
                                    <div class="product-caption">
                                        ...
                                        <h4><a :href="'product/'+products.id">{{ products.name }}</a></h4>
                                        <div class="price">
                                            <ul>
